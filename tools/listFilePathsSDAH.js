...
`
  ...
  filepaths.push(path.join(__dirname, "files", "lyrics", "created", "SDAH", filePath, 'docs.md'))
//   console.log(path.join(__dirname, "files", "lyrics", "created", "SDAH", filePath, 'docs.md'))
...
//  console.log(filepaths)
 let tmp = ''
 for(let i in filepaths)tmp+= `${filepaths[i].replace(__dirname, "")}\n`
 fs.writeFileSync(path.join(__dirname, "SDAHpaths.txt"), tmp)
 console.log(tmp)
}, 3000)
